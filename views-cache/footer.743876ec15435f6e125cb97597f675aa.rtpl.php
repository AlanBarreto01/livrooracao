<?php if(!class_exists('Rain\Tpl')){exit;}?>	<div class="brands-area">
	...
	<div class="pull-left">
	<input type="submit" value="Inserir Nome" name="name" class="checkout-button button alt wc-forward">
	</div>
	<h2>Livro de Oração</h2>
	<textarea disabled rows="48" cols="116" class="resize: none"
	name="name"><?php echo htmlspecialchars( $name, ENT_COMPAT, 'UTF-8', FALSE ); ?>
