...
<html lang="pt-br">
    ...
    <!-- Livro De Oração by livrodeoracao.com.br -->
                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            %if check %
                            <li><a href="/profile"><i class="fa fa-user"></i> user</a></li>
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="/"><img width="60%" src="/img/logo.png"></a></h1>
                    </div>
                </div>
                
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="/names">Inserir - <span class="cart-amunt">Nome</span> </a>
                    </div>
                </div>
            </div>
        </div>
